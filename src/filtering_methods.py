##from https://github.com/Yimeng-Zhang/feature-engineering-and-feature-selection/tree/master
...
def constant_feature_detect(data,threshold=0.98):
    ...
    for feature in data_copy.columns:
        predominant = (data_copy[feature].value_counts() / np.asarray(
                      len(data_copy)).astype(float)).sort_values(ascending=False).values[0]
